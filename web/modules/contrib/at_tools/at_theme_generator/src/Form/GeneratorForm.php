...
class GeneratorForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($at_core == FALSE) {
      ...
      $this->messenger()->addMessage(t('<a href="//www.drupal.org/project/adaptivetheme" target="_blank">Adaptivetheme</a> is a required base theme for all generated themes, <a href="//www.drupal.org/project/adaptivetheme" target="_blank">download the latest version for Drupal 8</a> and place in the themes directory.'), 'error');
    }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!empty($values['generate']['generate_machine_name'])) {
      ...
      if (isset($values['generate']['generate_type']) && !empty($values['generate']['generate_type'])) {
        ...
        $this->messenger()->addMessage(t('Bummer, something went wrong. Please try again or contact support.'), 'error');
      }
      ...
      // Refresh data.
      // TODO see if resetting all extensions is really needed
      ...
      $this->messenger()->addMessage(t('Bummer, something went wrong with the machine name, please try again or contact support.'), 'error');
    }
  }
}
